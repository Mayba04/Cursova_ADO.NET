...
namespace Bookstore.Migrations
{
    ...
    [Migration("20230302135630_InitialCreate")]
            ...
            modelBuilder.Entity("Bookstore.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Date = new DateTime(2023, 3, 2, 15, 56, 30, 17, DateTimeKind.Local).AddTicks(5255),
                            Price = 15.99m,
                            Quantity = 1
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            Date = new DateTime(2023, 3, 2, 15, 56, 30, 19, DateTimeKind.Local).AddTicks(8145),
                            Price = 10.99m,
                            Quantity = 1
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 2,
                            Date = new DateTime(2023, 3, 2, 15, 56, 30, 19, DateTimeKind.Local).AddTicks(8172),
                            Price = 19.99m,
                            Quantity = 1
                        });
                });
