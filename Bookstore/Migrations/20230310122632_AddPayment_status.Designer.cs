...
namespace Bookstore.Migrations
{
    ...
    [Migration("20230310122632_AddPayment_status")]
    partial class AddPayment_status
    {
            ...
            modelBuilder.Entity("Bookstore.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Date = new DateTime(2023, 3, 10, 14, 26, 31, 998, DateTimeKind.Local).AddTicks(7566),
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            Date = new DateTime(2023, 3, 10, 14, 26, 32, 0, DateTimeKind.Local).AddTicks(6927),
                            Payment_status = false,
                            Price = 10.99m,
                            Quantity = 1
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 2,
                            Date = new DateTime(2023, 3, 10, 14, 26, 32, 0, DateTimeKind.Local).AddTicks(6954),
                            Payment_status = false,
                            Price = 19.99m,
                            Quantity = 1
                        });
