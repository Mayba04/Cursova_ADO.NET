...
namespace Bookstore.Migrations
{
    ...
    [Migration("20230326091203_SommeDatabase")]
    partial class SommeDatabase
    {
            ...
            modelBuilder.Entity("Bookstore.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Date = new DateTime(2023, 3, 26, 12, 12, 2, 842, DateTimeKind.Local).AddTicks(998),
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            Date = new DateTime(2023, 3, 26, 12, 12, 2, 844, DateTimeKind.Local).AddTicks(215),
                            Payment_status = false,
                            Price = 10.99m,
                            Quantity = 1
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 2,
                            Date = new DateTime(2023, 3, 26, 12, 12, 2, 844, DateTimeKind.Local).AddTicks(233),
                            Payment_status = false,
                            Price = 19.99m,
                            Quantity = 1
                        });
