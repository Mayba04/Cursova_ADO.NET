...
namespace Bookstore.Migrations
{
    ...
    [Migration("20230326095242_AddStatusAdmin")]
    partial class AddStatusAdmin
    {
            ...
            modelBuilder.Entity("Bookstore.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Date = new DateTime(2023, 3, 26, 12, 52, 42, 37, DateTimeKind.Local).AddTicks(269),
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            Date = new DateTime(2023, 3, 26, 12, 52, 42, 39, DateTimeKind.Local).AddTicks(897),
                            Payment_status = false,
                            Price = 10.99m,
                            Quantity = 1
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 2,
                            Date = new DateTime(2023, 3, 26, 12, 52, 42, 39, DateTimeKind.Local).AddTicks(917),
                            Payment_status = false,
                            Price = 19.99m,
                            Quantity = 1
                        });
