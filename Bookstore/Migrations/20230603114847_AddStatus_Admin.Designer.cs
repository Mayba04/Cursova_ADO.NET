...
namespace Bookstore.Migrations
{
    ...
    [Migration("20230603114847_AddStatus_Admin")]
    partial class AddStatus_Admin
    {
            ...
            modelBuilder.Entity("Bookstore.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookId = 1,
                            ClientId = 1,
                            CreatedAt = new DateTime(2023, 6, 3, 14, 48, 47, 42, DateTimeKind.Local).AddTicks(1629),
                            Text = "Very cool book"
                        },
                        new
                        {
                            ...
                            BookId = 2,
                            ClientId = 2,
                            CreatedAt = new DateTime(2023, 6, 3, 14, 48, 47, 42, DateTimeKind.Local).AddTicks(1856),
            ...
            modelBuilder.Entity("Bookstore.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Date = new DateTime(2023, 6, 3, 14, 48, 47, 39, DateTimeKind.Local).AddTicks(5136),
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            Date = new DateTime(2023, 6, 3, 14, 48, 47, 41, DateTimeKind.Local).AddTicks(7439),
                            Payment_status = false,
                            Price = 10.99m,
                            Quantity = 1
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 2,
                            Date = new DateTime(2023, 6, 3, 14, 48, 47, 41, DateTimeKind.Local).AddTicks(7459),
                            Payment_status = false,
                            Price = 19.99m,
                            Quantity = 1
                        });
